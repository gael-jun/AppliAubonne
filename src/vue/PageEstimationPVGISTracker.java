...
public class PageEstimationPVGISTracker extends JPanel {
    ...
    /**
     * Construit la page d'estimation PVGIS Tracker avec formulaire, boutons et zone de graphes.
     */
    public PageEstimationPVGISTracker() {
         setLayout(new BorderLayout());
        JLabel label = new JLabel("Formulaire pour PV Suiveur (Tracker) - PVGIS");
    ...
    private void exporterResultatsEnPDF() {
        ...
        try {
            ...
            try {
                ...
                content.showText("Estimation PVGIS Suiveur (Tracker)");
                content.endText();
                y -= 30;
